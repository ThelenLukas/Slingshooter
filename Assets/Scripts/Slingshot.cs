...
public class Slingshot : MonoBehaviour {
	...
	void OnMouseDown() {
		...
		//Instance a projectile and store it in our "projectile" variable
	...
	void Update() {
		...
		//Convert mouse position in 3D World space
		...
		if (Input.GetMouseButtonUp (0)) {
			...
			// Set the projectile velocity to the negative mouse delta vector
